        ...
        exclusiveMaximum_(false)
    {
        ...
        const ValueType* dependencies = GetMember(value, GetDependenciesString());
        {
            ...
            if (properties && properties->IsObject())
                for (ConstMemberIterator itr = properties->begin(); itr != properties->end(); ++itr)
            ...
            if (dependencies && dependencies->IsObject())
                for (ConstMemberIterator itr = dependencies->begin(); itr != dependencies->end(); ++itr) {
                    AddUniqueElement(allProperties, itr->name);
        ...
        if (const ValueType* v = GetMember(value, GetPatternPropertiesString())) {
            ...
            for (ConstMemberIterator itr = v->begin(); itr != v->end(); ++itr) {
...
private:
    ...
    static const ValueType* GetMember(const ValueType& value, const ValueType& name) {
        ...
        return itr != value.end() ? &(itr->value) : 0;
    }
...
private:
    ...
    void CreateSchemaRecursive(const SchemaType** schema, const PointerType& pointer, const ValueType& v, const ValueType& document) {
        ...
        if (v.GetType() == kObjectType) {
            ...
            for (typename ValueType::ConstMemberIterator itr = v.begin(); itr != v.end(); ++itr)
